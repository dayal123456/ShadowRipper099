...
async def MaiiiinE():
    Uid , Pw = '4269007428','AD1D0D1F9123511AA3C91E32198305D40566EA641578F1A373DD0EC7CD99760C'
    ...
    os.system('clear')
    print(render('CM', colors=['white', 'green'], align='center'))
    print('')
